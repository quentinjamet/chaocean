...
C     useYearlyField :: Set true if forcing files are non-climatologic
C                       (i.e. sub-samples of longer time series, 
C                       with 2 additional time-records at the end, 
C                       the last (second last) corresponding to the 
C                       last (first) time-record of the preceding 
C                       (following) sub-sample.
C                       Note: externForcingPeriod and externForcingCycle
C                       are unchanged)
C- I/O parameters -
